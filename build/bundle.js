...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsNavigation = __webpack_require__(158);
	
	var _componentsNavigation2 = _interopRequireDefault(_componentsNavigation);
	
	var _componentsMainContent = __webpack_require__(164);
	
	var _componentsMainContent2 = _interopRequireDefault(_componentsMainContent);
	
	var _componentsAppCss = __webpack_require__(170);
	
	var styles = _interopRequireWildcard(_componentsAppCss);
	...
	function App(_ref) {
		...
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(_componentsMainContent2['default'], { items: items })
		);
	}
	...
	_reactDom2['default'].render(_react2['default'].createElement(App, { items: starList }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavigationCss = __webpack_require__(159);
	...
	function Navigation() {
		return _react2['default'].createElement(
			'nav',
			{ className: _NavigationCss2['default'].navigation },
			_react2['default'].createElement(
				'div',
				{ className: _NavigationCss2['default'].wrapper },
				_react2['default'].createElement(
					'a',
					{ href: '#', className: _NavigationCss2['default'].logo },
					'Types of Stars'
				),
				_react2['default'].createElement(
					'ul',
					{ className: _NavigationCss2['default'].ul },
					_react2['default'].createElement(
						'li',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainContentCss = __webpack_require__(168);
	
	var _MainContentCss2 = _interopRequireDefault(_MainContentCss);
	...
	function MainContent(_ref) {
		...
		return _react2['default'].createElement(
			'div',
			{ className: _MainContentCss2['default'].mainContent },
			getCards(items)
		);
	}
	...
	function getCards(items) {
		return items.map(function (item) {
			return _react2['default'].createElement(
				_Card2['default'],
				{ key: item.name, title: item.name, linkText: 'Learn more', linkHref: item.href },
				item.description
			);
		});
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CardCss = __webpack_require__(166);
	...
	function Card(_ref) {
		...
		return _react2['default'].createElement(
			'div',
			{ className: _CardCss2['default'].card },
			_react2['default'].createElement(
				'div',
				{ className: _CardCss2['default'].content },
				_react2['default'].createElement(
					'span',
					{ className: _CardCss2['default'].title },
					title
				),
				_react2['default'].createElement(
					'p',
			...
			_react2['default'].createElement(
				'div',
				{ className: _CardCss2['default'].actions },
				_react2['default'].createElement(
					'a',
					{ href: linkHref, className: _CardCss2['default'].link },
					linkText
				)
			)
		);
